  ...
  return (
    <ScrollView>
      <View style={{ flex: 1, padding: 20 }}>
        ...
        />
        <View style={{flexDirection: 'row', padding: 10, margin: 15, justifyContent: 'space-between'}}>
          <TouchableOpacity onPress={handleSaveChanges} style={{ backgroundColor: '#F4CE14', padding: 10, borderRadius: 10, width: 130, height: 40, alignItems: 'center', marginTop: 20 }}>
